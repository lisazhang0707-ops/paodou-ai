  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      <div className="flex flex-col md:flex-row gap-12 items-start mb-16">
        ...
        <div>
          <h1 className="text-3xl font-black text-slate-100 mb-6">Hi，我是 Lisa</h1>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        <div>
          <h2 className="text-lg font-bold text-slate-100 mb-3">关注领域</h2>
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-100 mb-3">找到我</h2>
          <ul className="space-y-2 text-slate-400">
            <li>· 微信：扫码添加</li>
            <li>· 知乎：@跑豆AI</li>
            <li>· 小红书：@跑豆AI</li>
